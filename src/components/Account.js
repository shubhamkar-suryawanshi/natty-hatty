...
const Account = () => {
  return (
    <div className="flex flex-col  p-5 m-2 rounded-sm md:bg-[#F5F6F8] md:space-y-4 md:py-5 md:px-3  md:m-0 lg:h-[200px]">
      ...
      <div className="flex flex-col md:space-y-3 lg:space-y-0 lg:flex-row lg:space-x-5 lg:items-center">
        <div className="card-1 lg:min-h-20 max-w-[350px] rounded-md flex justify-between bg-[#F5F6F8] md:bg-white items-center">
          ...
          <button className="rounded-sm text-white bg-[#0C611A] w-20 h-8 m-4 cursor-pointer">
            Edit
          </button>
        </div>
        <div className="card-2 lg:min-h-20 max-w-[350px] rounded-md flex justify-between bg-[#F5F6F8] md:bg-white items-center">
          <div className="flex items-center space-x-4  m-2 p-2 rounded-sm">
            <img className="w-16" alt="card" src={card} />
            <div>
