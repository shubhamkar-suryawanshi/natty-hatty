  ...
  return (
    <div className="flex flex-col  p-5 m-2 rounded-sm md:bg-[#F5F6F8] md:space-y-4 md:py-5 md:px-3  md:m-0 lg:h-[200px]">
      ...
      <div className="flex flex-col mb:space-y-3 sm:space-y-3 lg:space-y-0 lg:flex-row lg:space-x-5 lg:items-center">
        <div className="card-1  max-w-[350px] lg:w-72 h-20 rounded-md flex justify-between bg-[#F5F6F8] md:bg-white items-center">
          <div className="flex items-center space-x-4  m-2 p-2 rounded-sm">
            <img className="w-16 h-16" alt="card" src={card} />
            <div>
        ...
        <div className="card-2  max-w-[350px] lg:w-72 h-20 rounded-md flex justify-between bg-[#F5F6F8] md:bg-white items-center">
          <div className="flex items-center space-x-4  m-2 p-2 rounded-sm">
            <img className="w-16 h-16" alt="card" src={card} />
            <div>
